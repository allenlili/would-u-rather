...
class Unanswered extends Component {
	...
	render() {
		const { user, question, doSaveQuestionUserAction, doGetQuestionsAction } = this.props;
			...
			<div>
				{
					to === 'list' ?
						<PollList question={question}
											...
											doSaveQuestionUserAction={doSaveQuestionUserAction}
											doGetQuestionsAction={doGetQuestionsAction} handleTabChange={this.props.handleTabChange}/> : null
				}
				{
					to === 'poll' ?
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(withRouter(Unanswered)));